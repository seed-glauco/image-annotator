...
<ul class="tagFields">
   ...
   <fieldset>
    ...
    <li>   
        <label for="popup.meta.image">Image</label>
        <input type="url" name="popup.meta.image" required class="openFileDialog" data-wpvalue="media_details.sizes.full.source_url" onkeypress="return false;" onclick="_openWPML(event,this);" value="${
...
const _openWPML = function _openWPML(event, field) {
